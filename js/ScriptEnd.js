...
function ShowOnMobileOrDesktop2(){
    if($(window).width()>=1300){
        ...
        $(".Onlarge").show("slow");
        $(".onMobile").hide();
		$(".texteAuto").css({'font-size':'25px'});
    }else{
        $(".Onlarge").hide("slow");
        $(".onMobile").show();
		$(".texteAuto").css({'font-size':'16px'});  
		//redimensionner certains bloc
		//$(displacementChartMobile).css(width:"150");
    }
}
...
$('#carte g polygon').mouseover(function (e) {
    ...
    */
	...
	$('<div class="info_panel"><span class="regionInfoPanel">' 
		...
		+ '<br/>* <span class="texteTresPetit">Requirement for Adamawa, Borno, Yobe</span>'
		+ '</div>').appendTo('body');
    ...
    */
	...
	contenu = "<div class='detailContenu'><div class='blocTrans'><div class='col-lg-12 titreNoir ContenuAGauche'>"+regionData.region+"</div><div class='col-lg-12'><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyen happy'>People in need</span></div><div><img src='images/peopleUrgent.png'/><span class='texteMoyen3 happy'>"+inNedd+"</span></div></div><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyen happy'>People targeted</span></div><div><img src='images/TargetX30.png'/><span class='texteMoyen3 happy'>"+target+noteSigneTarget+"</span></div></div><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyen happy'>2017 requirement</span></div><div><img src='images/RequirementX30.png'/><span class='texteMoyen3 happy'>"+requier+noteSigne+"</span></div></div></div>"+note+"<div class='col-lg-12'><p>"+resume+"</p></div></div></div>";
...
$('#Menu img').click(function (e) {
	...
	switch(id) {
		...
		case 'ImgFsa':
            ...
            //$("#SectorInfo").html("<div id='titre' class='titre ContenuAGauche'>Food Security & Agriculture</div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People in need</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/peopleUrgent.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>7.3M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People targeted</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/TargetX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>5.9M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>2017 requirement</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/RequirementX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>645M</span></div></div></div>");
		...
		case 'ImgProtection':
            ...
            //$("#SectorInfo").html("<div id='titre' class='titre ContenuAGauche'>Protection</div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People in need</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/peopleUrgent.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>7M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People targeted</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/TargetX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>0.8M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>2017 requirement</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/RequirementX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>145.1M</span></div></div></div>");
			...
			break;
		case 'ImgShelter':
			datas = '[{"region":"Diffa","inNeeds":281000,"Target":180000,"FondsRequis":12342581,"Resume":"<ul><li>Distribute basic household items to some 40,000 vulnerable households.</li><li>Provide shelter in order to ensure their protection and dignity.</li><li>Distribute cash and commodity vouchers for the purchase of basic household items.</li></ul>"},{"region":"Lac","inNeeds":220500,"Target":166910,"FondsRequis":2596800,"Resume":"To provide the displaced population with dignified living conditions, while facilitating access to shelter and basic household items, it is essential to:<ul><li>Provide emergency shelter to 10,000 displaced people with specific needs (distribution of tarpaulins) and NFI to 60,000 displaced people.</li><li>Provide long-term solutions that promote self-sufficiency and/or reintegration of 125,000 displaced people.</li></ul>"},{"region":"Yobe","inNeeds":141073,"Target":1000000,"FondsRequis":70332436,"Resume":"<ul><li>Provide reinforced or temporary emergency shelters, repairs/rehabilitation and cash for shelter as well as nonfood items to 1 million people.</li><li>Distribute non-food item kits to the most vulnerable target groups, with replenishments made according to needs.</li></ul>"},{"region":"Borno","inNeeds":1675697,"Target":1000000,"FondsRequis":70332436,"Resume":"<ul><li>Provide reinforced or temporary emergency shelters, repairs/rehabilitation and cash for shelter as well as nonfood items to 1 million people.</li><li>Distribute non-food item kits to the most vulnerable target groups, with replenishments made according to needs.</li></ul>"},{"region":"Far-North","inNeeds":514890,"Target":314447,"FondsRequis":5599281,"Resume":"<ul><li>Distribute 33,000 shelter kits to 165,000 IDPs and hosts and help build 1,500 family shelters.</li><li>Distribute sleeping mats, blankets, mosquito nets and sanitary napkins to 42,000 IDP families.</li><li>Build 5,000 emergency shelters and distribute 20,000 NFI kits to refugees ; build 3,500 transitional shelters for vulnerable households living around the camp.</li><ul>"},{"region":"Adamawa","inNeeds":458974,"Target":1000000,"FondsRequis":70332436,"Resume":"<ul><li>Provide reinforced or temporary emergency shelters, repairs/rehabilitation and cash for shelter as well as nonfood items to 1 million people.</li><li>Distribute non-food item kits to the most vulnerable target groups, with replenishments made according to needs.</li></ul>"},{"region":"Total","inNeeds":1675697,"Target":1000000,"FondsRequis":70332436,"Resume":""}]';
			
            
            //$("#SectorInfo").html("<div id='titre' class='titre ContenuAGauche'>Shelter</div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People in need</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/peopleUrgent.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>3.2M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People targeted</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/TargetX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>0.6M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>2017 requirement</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/RequirementX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>90.8M</span></div></div></div>");
		...
		case 'ImgWash':
            ...
            //$("#SectorInfo").html("<div id='titre' class='titre ContenuAGauche'>Water, Hygiene and sanitation (Wash)</div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People in need</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/peopleUrgent.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>4.6M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>People targeted</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/TargetX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>0.7M</span></div></div></div><div class='shadowBox centrerContenu'><div><span class='texteMoyen3 happy'>2017 requirement</span></div><div><div class='col-xs-6 col-md-6  col-lg-6'><img src='images/RequirementX60.png'/></div><div class='col-xs-6 col-md-6  col-lg-6'><span class='titre happy'>81.2M</span></div></div></div>");
...
$('#GotoPage2').click(function (e) {
    ...
    $("#embebBloc").html("");
    $("#embebBloc").html("<iframe class='embed-responsive-item' id='myVideo' src='https://www.youtube.com/embed/WdhcD7UJZuA?autoplay=1'></iframe>");
...
$("#crise1").mouseover(function (e) {
    $('<div class="info_Crise"><span class="firstLetter">Lake Chad</span> is the world’s sixth largest lake</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
	$('.info_Crise').css({
	  top: mouseY-300,
	  left: mouseX - ($('.info_Crise').width() / 2)
	});
});
...
$("#crise2").mouseover(function (e) {
    $('<div class="info_Crise">Niger’s shore on the <span class="firstLetter">lake dries out</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise3").mouseover(function (e) {
    $('<div class="info_Crise">A <span class="firstLetter">cycle</span> of droughts hits the region</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise4").mouseover(function (e) {
    $('<div class="info_Crise"><span class="firstLetter">Boko Haram</span> launches its first <span class="firstLetter">attack</span> in Nigeria</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise5").mouseover(function (e) {
    $('<div class="info_Crise">FAO warns of ecological <span class="firstLetter">catastrophe</span> and humanitarian <span class="firstLetter">disaster</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#Bigcrise5").mouseover(function (e) {
    $('<div class="info_CriseCarre">FAO warns of ecological catastrophe and humanitarian disaster</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_CriseCarre').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise6").mouseover(function (e) {
    $('<div class="info_Crise">Food crisis, <span class="firstLetter">cholera</span> outbreak</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise7").mouseover(function (e) {
    $('<div class="info_Crise">Boko Haram <span class="firstLetter">attack</span> on <span class="firstLetter">UN compound</span> in Abuja</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise8").mouseover(function (e) {
    $('<div class="info_Crise">Boko Haram <span class="firstLetter">kidnaps 276 girls</span> from a boarding school in Chibok</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise9").mouseover(function (e) {
    $('<div class="info_Crise">Over <span class="firstLetter">one million</span> people are <span class="firstLetter">displaced</span> across 4 countries</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise10").mouseover(function (e) {
    $('<div class="info_Crise">Boko Haram expands <span class="firstLetter">raids</span> into Cameroon, Chad and Niger</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise11").mouseover(function (e) {
    $('<div class="info_Crise">2.6 million people have <span class="firstLetter">fled their homes</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise15").mouseover(function (e) {
    $('<div class="info_Crise"><span class="firstLetter">Famine-like</span> conditions in parts of Nigeria’s Borno and Yobe states</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise12").mouseover(function (e) {
    $('<div class="info_Crise">Resurgence of wild <span class="firstLetter">polio virus</span> in Borno state</div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise13").mouseover(function (e) {
    $('<div class="info_Crise">7 million people are facing <span class="firstLetter">hunger</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$("#crise14").mouseover(function (e) {
    $('<div class="info_Crise">10.7 million people need humanitarian <span class="firstLetter">assistance</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;
...
$('#slider').change(function() {
    var move =(856 * $(this).val())/100;
    
    
    
    $('#backgroundSliding').animate({
  'margin-left': +move+'px'
}, 10, 'linear');

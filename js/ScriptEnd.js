...
function SartTimeline(){
	$('#criseDetail').hide();
	contenu = "The fresh waters of Lake Chad have for centuries been a source of life. Today, the lake has shrunk to one tenth of its size and the people living on its shores suffer one of the world‘s most devastating crises.";
...
$('#carte g polygon').mouseover(function (e) {
    ...
    if(regionData.region=="Adamawa"||regionData.region=="Borno"||regionData.region=="Yobe"){
		note="<div class='col-lg-12'> * Requierement for all three affected states (Adamawa, Borno, Yobe)</div>"; 
		noteSigne="*";	  
    }

...
$('#GotoPage2').click(function (e) {
    ...
    $("#embebBloc").html("");
    $("#embebBloc").html("<iframe class='embed-responsive-item' id='myVideo' src='https://www.youtube.com/embed/AGt_QuTra0I?autoplay=1'></iframe>");
...
$("#crise5").mouseover(function (e) {
    $('<div class="info_Crise">UN warns of ecological <span class="firstLetter">catastrophe</span> and humanitarian <span class="firstLetter">disaster</span></div>').appendTo('body');
}).mouseleave(function () {
    $('.info_Crise').remove();
}).mousemove(function(e){
    var mouseX = e.pageX,mouseY = e.pageY;

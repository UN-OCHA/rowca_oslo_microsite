...
$('#carte g polygon').mouseover(function (e) {
    ...
    note='';
    noteSigneTarget='';
    noteSigneRequirement='';
    if(region_data.region=="Adamawa"||region_data.region=="Borno"||region_data.region=="Yobe"){
		note='<br/>* <span class="texteTresPetit">Requirement for Adamawa, Borno, Yobe</span>';  
        noteSigneRequirement = '*';
    }
    
    if((region_data.region=="Adamawa"||region_data.region=="Borno"||region_data.region=="Yobe")&&(region_data.Target==1000000)){
	...
	$('<div class="info_panel"><span class="regionInfoPanel">' 
		...
		+ 'Requirement in US$: '+ requier+noteSigneRequirement
		+ note
		+ '</div>').appendTo('body');
    ...
    */
	...
	contenu = "<div class='detailContenu'><div class='blocTrans'><div class='col-lg-12 titreNoir ContenuAGauche'>"+nomRegion+"</div><div class='col-lg-12' style='padding:0px'><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyenAuto happy'>People in need</span></div><div><img src='images/peopleUrgent.png'/><span class='texteMoyen3 happy'>"+inNedd+"</span></div></div><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyenAuto happy'>People targeted</span></div><div><img src='images/TargetX30.png'/><span class='texteMoyen3 happy'>"+target+noteSigneTarget+"</span></div></div><div class='blocNoir col-xs-4 col-sm-4 col-md-4 col-lg-4 centrerContenu'><div><span class='texteMoyenAuto happy'>2017 requirement</span></div><div><img src='images/RequirementX30.png'/><span class='texteMoyen3 happy'>"+requier+noteSigne+"</span></div></div></div>"+note+"<div class='col-lg-12'><p>"+resume+"</p></div></div></div>";
